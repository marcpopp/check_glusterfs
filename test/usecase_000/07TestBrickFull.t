...
if [ "\$1 \$2" == "volume info" ]; then
	...
	for i in server{1..1}; do
		...
		echo Inode Size           : 512                 
		echo Disk Space Free      : 7.0GB             
		echo Total Disk Space     : 100.0GB             
		echo Inode Count          : 10000           
		echo Free Inodes          : 700
	done
	for i in server{2..3}; do
		echo ------------------------------------------------------------------------------
		echo Brick                : Brick \$i:/data/glusterfs/volume01/brick1
		echo TCP Port             : 49152               
		echo RDMA Port            : 0                   
...
print $result->{stdout},"\n";
is ($result->{stdout}, "WARNING - volume01_b1 inodes warning, volume01_b1 diskspace warning\n", "One brick is getting full");
...
print $result->{stdout},"\n";
is ($result->{stdout}, "CRITICAL - volume01_b1 inodes is critical, volume01_b1 diskspace is critical\n", "One brick is full");
