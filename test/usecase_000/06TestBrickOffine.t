...
print $result->{stdout},"\n";
is ($result->{stdout}, "WARNING - volume01_b1 is offline, Peer 'server1' is in non-acceptable state 'Not connected'\n", "One brick is down");
...
print $result->{stdout},"\n";
is ($result->{stdout}, "CRITICAL - volume01_b1 is offline, volume01_b2 is offline, Peer 'server1' is in non-acceptable state 'Not connected', Peer 'server2' is in non-acceptable state 'Not connected'\n", "Two brick are down");
